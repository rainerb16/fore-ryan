...
export const winContestBtn = need<HTMLButtonElement>("winContestBtn");
export const winHomeBtn = need<HTMLButtonElement>("winHomeBtn");
export const loseBtn = need<HTMLButtonElement>("loseBtn");
export const loseContestBtn = need<HTMLButtonElement>("loseContestBtn");
export const loseHomeBtn = need<HTMLButtonElement>("loseHomeBtn");
