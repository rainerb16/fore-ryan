...
| `scripts/make-og.mjs` | Regenerates the link-preview card in `public/og.png` |
...
`public/og.png` is what Slack, Teams, and mail show when the link is pasted. It
is generated by `scripts/make-og.mjs` and committed, so a normal install and a
